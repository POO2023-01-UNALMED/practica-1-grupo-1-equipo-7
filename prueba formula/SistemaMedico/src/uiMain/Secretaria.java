...
public class Secretaria {
    ...
    static public void formulaMedica() {
        ...
        ArrayList<Doctor> doctoresCita = paciente.getHistoriaClinica().buscarCitaDoc(enfermedadTratar.getEspecialidad()); /* metodo de la historia del paciente
        ...
        do {
            ...
            ArrayList<Medicamento> disponibleEnf = paciente.medEnfermedad(enfermedadTratar);
            ...
            float precioForm = paciente.calcularPrecio(listMedicamento);
